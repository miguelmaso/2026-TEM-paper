...
\draw[->, shorten <=35pt, shorten >=30pt]
  ...
  (Bt);
\draw[->, shorten <=32pt, shorten >=30pt]
  (B0) to[out=330, in=150]
  node[midway, above right] {$\F_{v_1}$}
  (B1);
\draw[->, shorten <=30pt, shorten >=30pt]
  (B0) to[out=280, in=140]
  node[midway, above] {$\F_{v_\alpha}$}
  (B2);
\draw[->, shorten <=35pt, shorten >=30pt]
  (B1) to[out=30, in=230]
  node[midway, above] {$\F_{e_1}$}
  (Bt);
\draw[->, shorten <=40pt, shorten >=30pt]
  (B2) to[out=40, in=260]
  node[midway, below right] {$\F_{e_\alpha}$}
  (Bt);
