...
Consideration of the functional spaces for $\{\vect{v},\vect{\phi},\theta\}$ and $\{\vect{w}_{\vect{v}},\vect{w}_{\vect{\phi}},w_{\theta}\}$ in \eqref{eqn:functional spaces for discretisation} and \eqref{eqn:functional spaces for discretisation virtual} enables  $\{(\mathcal{W}_{\vect{\phi}})_{\text{algo}},(\mathcal{W}_{{\varphi}})_{\text{algo}},(\mathcal{W}_{\theta})_{\text{algo}}\}$  in \eqref{eqn:weak forms for proposed time integrator} to be written in terms of their associated elemental residual contributions, namely
%
\begin{equation}
  \begin{aligned}	
    \left(\mathcal{W}_{\vect{\phi}}\right)_{\text{algo}} &= \sum_{e=1}^N{\vect{w}_{\vect{\phi}}}_a\cdot\vect{R}_{a,e}^{\vect{\phi}};&\quad
    %
    \left(\mathcal{W}_{\varphi}\right)_{\text{algo}} &= \sum_{e=1}^N{w_{\varphi}}_a{R}_{a,e}^{\varphi};\qquad
    %
...
The residual contributions $\vect{R}^{\vect{\phi}}_{a,e}$, ${R}_{a,e}^{\varphi}$ and ${R}^{{\theta}}_{a,e}$ can be expressed as\footnote{For simplicity, the external contributions on the boundary of the continuum and associated with $\vect{t}_0$ and $Q_{\theta}$ have not been included in \eqref{eqn:the residuals}.}
%
\begin{equation}
  ...
  \begin{aligned}
    ...
    \vect{R}_{a,e}^{\vect{\phi}} &=
      ...
      \int_{\mathcal{B}_0^e}\vect{P}_{n+1/2}\vect{\nabla}_0N^{\vect{\phi}}_a\,dV +
    ...
    R_{a,e}^{\theta} &=
      ...
      \int_{\mathcal{B}_0}\frac{\Delta \theta}{\Delta t}\eta_{n+1/2}N^{\theta}_a\,dV -
      \int_{\mathcal{B}_0}\mathcal{D}_{n+1/2}N^{\theta}_a\,dV\\&-
