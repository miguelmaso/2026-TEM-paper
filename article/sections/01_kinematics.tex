...
\begin{aligned}
\rho_0\dot{\vect{v}} - \text{DIV}(\vect{P}) - \vect{f}_0& = \vect{0};&\qquad &\text{in}\,\,\B_0\times \left[0,T\right];\\
%
\P\vect{N}& = \vect{t}_0;&\qquad&\text{on}\,\,\partial_{\boldsymbol{t}}\B_0\times \left[0,T\right];\\
%
...
\subsection{Governing equations in non-linear thermo-electro-mechanics: conservation of energy}\label{sec:conservation of energy}
