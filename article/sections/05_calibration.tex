...
\begin{enumerate}
    \item \emph{Commercial optimization intent:} VHB polymers are manufactured primarily as industrial adhesive tapes rather than structural engineering elastomers; hence, factory quality control prioritizes viscoelastic tack and peel strength over strict consistency in bulk visco-hyperelastic Moduli.
    \item \emph{Thickness-dependent curing:} The polymer is supplied in various nominal thicknesses, which alters the UV cross-linking and curing kinetics during production, yielding distinct underlying cross-link densities.
...
\subsubsection{Kinematic Generalization and Hyperelastic Model Transition}
\label{subsubsec:model_transition}
