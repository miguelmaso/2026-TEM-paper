...
Furthermore, because the BDS analyzer records an idealized one-dimensional scalar response $\epsilon_{\text{BDS}}$ along the specific thickness, the second-order tensor equation \eqref{eqn:bds_epsilon_general} must be projected into a scalar observable as
%
