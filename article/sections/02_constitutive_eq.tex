...
\begin{equation}\label{eqn:disssipation1}
	\mathcal{D}= \vect{P}:\dot{\vect{F}} - \vect{D}_0\cdot \dot{\vect{E}}_0 - \eta \dot{\theta} - \dot{\Psi}\left(\vect{F},\vect{E}_0,\theta,\A\right)\geq 0
\end{equation}
%
...
%
\begin{equation}
	\mathcal{D}\left(\vect{F},\vect{E}_0,\theta,\A\right)=-	\sum_{i={\alpha}}^{n_\text{Maxw}}\partial_{\vect{A}_{\alpha}}\Psi: \dot{\vect{A}_{\alpha}}
\end{equation}
...
\begin{subequations}
	...
	\begin{align}
		...
		%		\begin{split}
			%			\label{eq10.2}
			%			&\C_{\mathrm{e}_\alpha}=\F^{\mathrm{T}}_{\mathrm{e}_\alpha} \F_{\mathrm{e}_\alpha};
			%		\end{split}\\
		\begin{split}
			\label{eq10.3}
...
To guarantee that $\Psi_\alpha$ vanishes when $\boldsymbol{U}_{\mathrm{v}_\alpha}$ and $\F$ only differ by a rigid body rotation (i.e. thermo-dynamical equilibrium), Bonet et al. XXX particularise the definition of $\Psi_\alpha$  as 
%
\begin{equation}
	\label{eq12}
	\Psi_\alpha \left(\C,\U_{\mathrm{v}_\alpha}\right) = \widetilde{\Psi}_\alpha\left(\C_{\mathrm{e}_\alpha} \right),
\end{equation}
%
...
\begin{equation}
	\label{eq57}
	\Psi_\alpha (\C,~\boldsymbol{U}_{\mathrm{v}_{\alpha}}) = \hat{\\widetilde{\Psi}}_\alpha\left( \C_{\mathrm{e}_{\alpha}}\right)=\widetilde{\Psi}_\alpha\left( \hat{\C}_{\mathrm{e}_{\alpha}}\right); \quad\quad\quad\quad \hat{\C}_{\mathrm{e}_{\alpha}} = J_{\mathrm{e}_{\alpha}}^{-\frac{2}{3}}\C_{\mathrm{e}_{\alpha}},
\end{equation}
%
...
\end{equation}
%
and substituting the directional derivative of \eqref{eqn:Cea} with respect to $\delta \C$ into \eqref{eq:Sea_Sa} results in
%
\begin{equation}
	\label{eq18}
...
\begin{equation}
	\label{eq23}
	\left.\frac{\mathrm{d}\C_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} = 2 \mathbb{C}_{\mathrm{e}_{\alpha}}^{-1} : \left.\frac{\mathrm{d}\boldsymbol{S}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}},
\end{equation}
%
where $\mathbb{C}_{\mathrm{e}_{\alpha}}=2 \frac{\partial \boldsymbol{S}_{\mathrm{e}_{\alpha}}}{\partial \C_{\mathrm{e}_{\alpha}}}$ is the so-called fourth order (positive definite) Lagrangian elasticity tensor. Crucially, $\mathbb{C}_{\mathrm{e}_{\alpha}}$ and its inverse $\mathbb{C}_{\mathrm{e}_{\alpha}}^{-1}$ can be straightforwardly obtained for simple user defined strain energy densities (i.e. Saint-Venant, neo-Hookean) \cite{Bonet_book_statics}.
%
...
\begin{equation}
	\label{eq28}
	\mathrm{D}_{\mathrm{vis}} = -\sum_{\alpha} \boldsymbol{S}_{\mathrm{e}_{\alpha}} : \mathbb{C}_{\mathrm{e}_{\alpha}}^{-1} : \left.\frac{\mathrm{d}\boldsymbol{S}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}},
\end{equation}
%
...
\begin{equation}
	\label{eq29}
	\left.\frac{\mathrm{d}\boldsymbol{S}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} = - \frac{1}{\tau_\alpha} \boldsymbol{S}_{\mathrm{e}_{\alpha}}; \quad\quad\quad  \tau_\alpha > 0,
\end{equation}
%
...
Since the elastic second Piola-Kirchhoff stress tensor $\boldsymbol{S}_{\mathrm{e}_{\alpha}}$ is a function of both the total deformation gradient $\F$ and viscous stretch $\boldsymbol{U}_{\mathrm{v}_{\alpha}}$, the left-hand side of \eqref{eq29} can be transformed as
%
\begin{equation}
	\label{eq30}
...
\begin{equation}
	\label{eq64}
	\bar{\mathbb{C}}_{\mathrm{e}_{\alpha}} = 2 \frac{\partial \boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}}}{\partial \C_{\mathrm{e}_{\alpha}}} + m \C_{\mathrm{e}_{\alpha}}^{-1} \otimes \C_{\mathrm{e}_{\alpha}}^{-1},
\end{equation}
%
...
\begin{equation}
	\label{eq65.2}
	\left.\frac{\mathrm{d}\C_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} = 2 \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \left.\frac{\mathrm{d}\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}}.
\end{equation}
%
...
\begin{equation}
	\label{eq66}
	\left.\frac{\mathrm{d}\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} = - \frac{1}{\tau_\alpha} \left(\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{'} - \lambda_\alpha \C_{\mathrm{e}_{\alpha}}^{-1}\right),
\end{equation}
%
...
\begin{equation}
	\label{eq67}
	\lambda_\alpha = \frac{\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}}{\C_{\mathrm{e}_{\alpha}}^{-1} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}},
\end{equation}
%
...
\begin{equation}
	\label{eq68}
	\begin{aligned}
		\mathrm{D}_{\mathrm{vis}} &= -\sum_{\alpha} \boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}_{\mathrm{e}_{\alpha}}^{-1} : \left.\frac{\mathrm{d}\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} \\
		&=\sum_{\alpha} \frac{1}{\tau_\alpha} \boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}_{\mathrm{e}_{\alpha}}^{-1} : \left( \boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} - \frac{\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}}{\C_{\mathrm{e}_{\alpha}}^{-1} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}} \C_{\mathrm{e}_{\alpha}}^{-1} \right) \\
		& = \sum_{\alpha} \frac{1}{\tau_\alpha} \frac{ (\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}_{\mathrm{e}_{\alpha}}^{-1} : \boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}})(\C_{\mathrm{e}_{\alpha}}^{-1} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}) - (\boldsymbol{S}^{'}_{\mathrm{e}_{\alpha}} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1})^2 }{\C_{\mathrm{e}_{\alpha}}^{-1} : \bar{\mathbb{C}}^{-1}_{\mathrm{e}_{\alpha}} : \C_{\mathrm{e}_{\alpha}}^{-1}} \\
		&\geq 0,
	\end{aligned}
\end{equation}
%
...
\begin{equation}
	\label{eq34}
	\left.\frac{\mathrm{d}\boldsymbol{S}_{\mathrm{e}_{\alpha}} }{\mathrm{d}t} \right|_{\F=\text{const}} = \frac{1}{\Delta t} \left( \boldsymbol{S}_{\mathrm{e}_{\alpha}}^{n+1} - \boldsymbol{S}_{\mathrm{e}_{\alpha}}^{*} \right),
\end{equation}
%
...
\begin{equation}
	\label{eq35}
	\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{*} = \boldsymbol{S}_{\mathrm{e}_{\alpha}} \left(\C^{n+1},~\boldsymbol{U}_{\mathrm{v}_{\alpha}}^n \right) \quad \text{and} \quad \boldsymbol{S}_{\mathrm{e}_{\alpha}}^{n+1} = \boldsymbol{S}_{\mathrm{e}_{\alpha}} \left(\C^{n+1},~\boldsymbol{U}_{\mathrm{v}_{\alpha}}^{n+1} \right),
\end{equation}
%
...
\end{equation}
%
Note that the final relaxation stress $\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{n+1}$ is proportional to the instantaneous stress $\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{*}$\footnote{This projection can be identified with the radial return scheme in the context of elastoplasticity}, and compared with the direct time integration of Eqs.~\eqref{eq31}-\eqref{eq32}, computational implementation of \eqref{eq37} is considerably simpler. Once the final relaxation stress $\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{n+1}$ is computed, the elastic right-Cauchy-Green strain tensor $\C_{\textrm{e}_{\alpha}}^{n+1}$ can be determined making use of the user-defined strain energy density $\tilde{\Psi}_{\alpha}$. After obtaining $\C_{\mathrm{e}_{\alpha}}^{n+1}$, the corresponding viscous state variable $\boldsymbol{U}_{\mathrm{v}_{\alpha}}^{n+1}$ can be derived from \eqref{eqn:Cea}. It is possible to show by direct substitution that the symmetric viscous stretch tensor $\boldsymbol{U}_{\mathrm{v}_{\alpha}}^{n+1}$ can be obtained as
%
\begin{equation}
	\label{eq41}
	\boldsymbol{U}_{\mathrm{v}_{\alpha}}^{n+1} = \left(\boldsymbol{U}_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1}  \left( \boldsymbol{U}_{\mathrm{e}_{\alpha}}^{n+1}  \C^{n+1}  \boldsymbol{U}_{\mathrm{e}_{\alpha}}^{n+1} \right)^{\frac{1}{2}}  \left(\boldsymbol{U}_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1}; \quad \quad\quad\quad \boldsymbol{U}_{\mathrm{e}_{\alpha}}^{n+1} = \left( \C_{\mathrm{e}_{\alpha}}^{n+1} \right)^{\frac{1}{2}}.
\end{equation}
%
...
\begin{algorithm}
  ...
  \label{alg:compressible_internal_variable}
	\begin{algorithmic}[1]
		...
		\State Obtain the elastic right Cauchy-Green tensor $\C_{\mathrm{e}_{\alpha}}^{n+1}$ via stress energy density $\tilde{\Psi}_{\alpha}$
...
Notice that for the case of a simple Saint-Venant-Kirchhoff material model, computation of $\C_{\mathrm{e}_{\alpha}}^{n+1}$ accepts a closed-form solution, whilst for other more nonlinear models (i.e. neo-Hookean), a simple Newton-Raphson scheme can be needed. Specifically, in the case of the simple Saint-Venant-Kirchhoff material model, \eqref{eq37} results in
%
\begin{equation}
	\label{eq38}
	\frac{1}{2} \lambda_{\alpha} \left(\mathrm{tr} \C_{\mathrm{e}_{\alpha}}^{n+1} - 3\right) \boldsymbol{I} + \mu_{\alpha}\left( \C_{\mathrm{e}_{\alpha}}^{n+1} - \boldsymbol{I} \right) = \gamma_{\alpha} \boldsymbol{S}_{\mathrm{e}_{\alpha}}^{*},
\end{equation}
%
expressed in terms of the lame coefficients $\lambda_{\alpha}$ and $\mu_{\alpha}$, which admits a closed-form solution for  $\C_{\mathrm{e}_{\alpha}}^{n+1}$. Analogously, in the case of a neo-Hookean material model, \eqref{eq37} takes the explicit form of
%
\begin{equation}
	\label{eq39}
	\mu_{\alpha} \left(\boldsymbol{I} - \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1} \right)  + \frac{\lambda_{\alpha} }{2}\ln \left({\det \C_{\mathrm{e}_{\alpha}}^{n+1}}\right)     \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1} = \gamma_{\alpha} \boldsymbol{S}_{\mathrm{e}_{\alpha}}^{*},
\end{equation}
%
which can be easily solved for $\C_{\mathrm{e}_{\alpha}}^{n+1}$ via a Newton-Raphson type of iterative solution scheme. 
...
\begin{equation}
	\label{eq69}
	\frac{1}{\Delta t} ( \boldsymbol{S}^{'n+1}_{\mathrm{e}_{\alpha}} - \boldsymbol{S}^{'*}_{\mathrm{e}_{\alpha}} ) = - \frac{1}{\tau_\alpha} \left(\boldsymbol{S}^{'n+1}_{\mathrm{e}_{\alpha}} - \lambda_\alpha^{n+1} \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1}\right),
\end{equation}
%
...
\begin{algorithm}
  ...
  \label{alg:incompressible_internal_variable}
	\begin{algorithmic}[1]
		...
		\State Calculate the right Cauchy-Green strain tensor at the current time increment $\C^{n+1}$
		\State Compute the instantaneous stress tensor $\boldsymbol{S}^{'*}_{\mathrm{e}_\alpha}$
		\State Obtain the elastic right Cauchy-Green tensor $\C_{\mathrm{e}_{\alpha}}^{n+1}$ by the solution of Eq.~\eqref{eq69} and Eq.~\eqref{eq71}
		\State Determine the internal variable $\boldsymbol{U}^{n+1}_{\mathrm{v}_\alpha}$ according to Eq.~\eqref{eq41}
		\EndFor
		\State Store the internal variable $\boldsymbol{U}^{n+1}_{\mathrm{v}_\alpha}$ as history variable
		\EndFor
...
\begin{equation}
	\label{eq72}
	\boldsymbol{S}^{'n+1}_{\mathrm{e}_{\alpha}} - \bar{\eta}^{n+1} \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1} = \gamma_{\alpha} \boldsymbol{S}^{'*}_{\mathrm{e}_{\alpha}};\quad\quad\quad \bar{\eta}^{n+1} = \frac{\Delta t}{\tau_\alpha + \Delta t}\lambda_{\alpha}^{n+1};\quad\quad\quad \gamma_{\alpha}=\frac{\tau_\alpha}{\tau_\alpha + \Delta t}.
\end{equation}
%
...
\begin{equation}
	\label{eq74}
	\mu_{\alpha} J_{n+1}^{-\frac{2}{3}}\left( \boldsymbol{I} - \frac{1}{3} \mathrm{tr}\C_{\mathrm{e}_{\alpha}}^{n+1} \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1} \right) - \bar{\eta}^{n+1} \left(\C_{\mathrm{e}_{\alpha}}^{n+1}\right)^{-1} = \gamma_{\alpha} \boldsymbol{S}^{'*}_{\mathrm{e}_{\alpha}},
\end{equation}
%
...
\begin{equation}
	\label{eq75}
	\C_{\mathrm{e}_{\alpha}}^{n+1} = \bar{\gamma}_{n+1} \left( \boldsymbol{I} - \frac{  \gamma_{\alpha}}{\mu_{\alpha}}J_{n+1}^{\frac{2}{3}} \boldsymbol{S}^{'*}_{\mathrm{e}_{\alpha}} \right)^{-1},
\end{equation}
%
...
\begin{equation}
	\label{eq76}
	\bar{\gamma}^{n+1} = \frac{\mu_{\alpha} \mathrm{tr}\C_{\mathrm{e}_{\alpha}}^{n+1} + 3\bar{\eta}^{n+1} J_{n+1}^{\frac{2}{3}} }{3 \mu_{\alpha}}.
\end{equation}
%
...
\begin{equation}
	\label{eq77}
	\mathrm{det} \C_{\mathrm{e}_{\alpha}}^{n+1} = \frac{\bar{\gamma}_{n+1}^3}{\mathrm{det}\left( \boldsymbol{I} - \frac{\gamma_{\alpha} }{\mu_{\alpha}}J_{n+1}^{\frac{2}{3}} \boldsymbol{S}^{'*}_{\mathrm{e}_{\alpha}} \right) } = J_{n+1},
\end{equation}
%
...
\end{equation}
%
which along with \eqref{eq75} provides a computationally efficient closed-form expression for $\C_{\mathrm{e}_{\alpha}}^{n+1}$. 
...
%\begin{equation}
%	\label{fakeeq64}
%	\left.\frac{\mathrm{d}\boldsymbol{S}_{\mathrm{e}_{\alpha}}^{'} \left(\F,~\boldsymbol{U}_{\mathrm{v}_\alpha} \right)}{\mathrm{d}t} \right|_{\F=\text{const}} = \frac{1}{2} \mathbb{C}_{\mathrm{e}_{\alpha}} : \left.\frac{\mathrm{d}\C_{\mathrm{e}_{\alpha}} \left(\F,~\boldsymbol{U}_{\mathrm{v}_\alpha} \right)}{\mathrm{d}t} \right|_{\F=\text{const}},
%\end{equation}
%%
