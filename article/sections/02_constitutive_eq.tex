...
\Blue{
¿CUÁNTO EXTENDEMOS LA SECCIÓN?
\begin{itemize}
  \item Cuánto aporta el párrafo en azul? Se podría sustituir por dos frases: analogía con plasticidad, positividad en caso de no linealidad de $\tau$.
...
As for the Lagrange multiplier $\lambda_\alpha^{n+1}$, rather than using Eq. \eqref{eqn:Lagrange_multiplier}, it can be incrementally obtained by enforcing the constraint
\begin{equation}
