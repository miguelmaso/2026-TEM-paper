...
\author{M. Franke$^\dagger$\fnref{cor1}} 
\author{R. Ortigosa$^\dagger$\fnref{cor2}}
\author{J. Mart\'inez-Frutos$^\ddagger$\fnref{cor4}} \author{A. J. Gil$^\diamond$} \author{P. Betsch$^\star$} 
\fntext[cor1]{Corresponding author: r.ortigosa@swansea.ac.uk}
\fntext[cor2]{Corresponding author: marlon.franke@kit.edu@kit}
%\fntext[cor3]{Corresponding author: alexander.janz@kit.edu}
\fntext[cor4]{Corresponding author: a.j.gil@swansea.ac.uk}
%\fntext[cor5]{Corresponding author: peter.betsch@kit.edu}
\address{$\dagger$ Computational Mechanics and Scientific Computing Group,\\
	Technical University of Cartagena, Campus Muralla del Mar, 30202, Cartagena (Murcia), Spain\\
	$\ddagger$Zienkiewicz Centre for Computational Engineering, College of Engineering \\ Swansea University, Bay Campus, SA1 8EN, United Kingdom}
\address{$\diamond$Institute of Mechanics, Karlsruhe Institute of Technology, 76131 Karlsruhe, Germany\\
$\star$ University of Greenwich, London, SE10 9LS, United Kingdom}
